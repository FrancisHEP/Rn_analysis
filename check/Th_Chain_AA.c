...
void Th_Chain_AA(int runnumber)
{
...
//	ifstream inf("./good.lst");
  //      for(std::string line; std::getline(inf,line);) chain->Add(line.c_str());
    ...
    TFile *outFile = new TFile(Form("outTree_220_216_%d.root",runnumber),"recreate");
    TTree *outTree = new TTree("rn220_AA","rn220_AA");
...
//        ly = 4.4/1.1732;
        ...
        double lowAlpha1 = 3200*ly_Alpha;//qS1 charge ranges
