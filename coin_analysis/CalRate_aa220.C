...
void CalRate_aa220(int runNo)
{
  TChain *chain;
  chain = new TChain("rn220_AA");
  TString pathfile = Form("aa220/outTree_220_216_%d.root",runNo);
  chain->Add(pathfile);

  // TChain *chain;
  // chain = new TChain("rn220_AA");
  // chain->Add("outTree_220_216_run10.root");
  ...
  chain->Draw("deltaT/1000000>>h2",Cut3,"");
