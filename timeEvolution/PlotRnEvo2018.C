...
// daqfile, rnEvofile
// void PlotRnEvo2018()
void PlotRnEvo2018(const char * inputfilename1, const char * inputfilename2)
{
  ...
  //   cout << time[i] << " " << Rn222[i] <<endl;
  // }

  // TString t[5] = {"Rn222", "Rn222", "Rn222", "Rn222", "Rn222"};
  // TString e[5] = {"Rn222err", "Rn222err", "Rn222err", "Rn222err", "Rn222err"};
  // int ii = 3;
  TGraph * g1;
  g1 = new TGraphErrors(i,time,Po212,duration,Po212err);
  g1->SetTitle("");
  ...
  g1->Draw("");
  c1->SaveAs("fig_Po212.pdf");
  c1->SaveAs("fig_Po212.root");
