...
void Single_Alpha(){
  ...
  ifstream inf("./good_20170727.lst");
  ...
  signal_tree->Draw("log10(qS2cr/qS1Maxcr):log10(qS1Maxcr)>>h1(200,4,5.5,200,-4,4)",Pulse_Shape&&""&&FV,"colz");
  ...
  signal_tree->Draw("qS1Maxcr>>h2(100,10000,100000)",Pulse_Shape&&""&&FV,"");
  ...
  TString energy = Form("qS1Maxcr/%.3f*5.59>>h3(100,4,10)",Mean_1);
  ...
  TString energy_1 = Form("qS1Maxcr/%.3f*5.59>>h4(10,6.7,7.3)",Mean_1);
  ...
  TString energy_2 = Form("qS1Maxcr/%.3f*5.59>>h5(50,7,10)",Mean_1);
  ...
  TString energy_3 = Form("qS1Maxcr/%.3f*5.59>>h6(20,5.8,7)",Mean_1);
  ...
  TString energy_all = Form("qS1Maxcr/%.3f*5.59>>h7(100,4,10)",Mean_1);
